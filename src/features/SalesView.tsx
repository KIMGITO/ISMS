                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-1.5">
                        ...
                        <button onClick={() => { if (!generatedReceipt) return; ReceiptService.exportToPdf(generatedReceipt.content, generatedReceipt.settings); }} className="py-2 px-1 text-center bg-app-card border border-app-border hover:bg-app-border text-app-text font-bold rounded-xl text-[9.5px] transition flex flex-col items-center justify-center gap-1 cursor-pointer"><Download size={14} className="text-emerald-400" /><span>PDF File</span></button>
                      </div>
                    </div>
